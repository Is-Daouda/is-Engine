...
When you want to use a texture with vertices, you must set the **useWithVertices** parameter to **true** in the **loadFromFile()** function, which is necessary when using SFML with SDL2.
```cpp
    sf::Texture texture;
