...
public:
    ...
    void loadResources() {
        ...
        SDMaddSceneObject(std::make_shared<is::Background>(m_texBackground, 0.f, 0.f, this, 0.5f, -0.5f));
        ...
        SDMaddSceneObject(std::make_shared<HelloWorld>(m_texHelloWorld, 0.f, 0.f, this));

        // add RPG style game dialog
        auto gameDialog = std::make_shared<is::GameDialog>(m_texDialog, m_fontMsg, this);
