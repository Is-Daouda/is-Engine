...
//////////////////////////////////////////////////////////////////////////////////////////////////////
    while (m_app.isOpen())
    {
        ...
        {
            case is::GameDisplay::DisplayOption::INTRO : // intro
            ...
            case is::GameDisplay::DisplayOption::MAIN_MENU : // main menu
            ...
            case is::GameDisplay::DisplayOption::RESTART_LEVEL : // restart level (when player lose)
                ...
                else // no more lives GAME OVER
                {
                    ...
                    m_launchOption = is::GameDisplay::DisplayOption::GAME_OVER; // go to GAME OVER scene
                }
            break;

            case is::GameDisplay::DisplayOption::NEXT_LEVEL : // next level (when player win)
               // clear level data
                m_gameSysExt.m_currentBonus = 0;
                #if defined(__ANDROID__)
                #if defined(ENABLE_ADMOB)
                ...
                {
                    m_launchOption = is::GameDisplay::DisplayOption::GAME_END_SCREEN; // go to game end scene
                }
            break;
            ...
            case is::GameDisplay::DisplayOption::QUIT_GAME : // close application
                m_app.close();
            break;
        }
    }
